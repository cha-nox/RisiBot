...
//Boucle expérimentale pour le statut du bot :
bot.on('messageReactionAdd',async (reaction, user, member) =>{
    ...
    //Autres constantes pour le bon fonctionnement des commandes. :
        const prefix = '&';
